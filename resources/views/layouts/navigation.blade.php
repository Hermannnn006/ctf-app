<x-splade-toggle>
    <nav class="bg-transparent border-b border-purple-200 lg:border-gray-100">
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <x-nav-link href="/chalengge" :active="request()->routeIs(['chalengge.index'])">
                            {{ __('Challenge') }}
                        </x-nav-link>
        ...
        <div v-bind:class="{ block: toggled, hidden: !toggled }" class="sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-responsive-nav-link href="/chalengge" :active="request()->routeIs('chalengge.index')">
                    {{ __('Challenge') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('scoreboard.index')" :active="request()->routeIs('scoreboard.index')">
                    {{ __('Scoreboard') }}
                </x-responsive-nav-link>
